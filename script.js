  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '' && field.hasAttribute('minlength')) {
        ...
        if (value.length < min) {
          showFieldError(field, fieldLabel + ' must be at least ' + min + ' characters.');
          return false;
        }
      }
      ...
      if (value !== '' && field.hasAttribute('maxlength')) {
        ...
        if (value.length > max) {
          showFieldError(field, fieldLabel + ' must not exceed ' + max + ' characters.');
          return false;
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6196d710-2bc2-42ad-b493-50a3dfb09987',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6196d710-2bc2-42ad-b493-50a3dfb09987';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6196d710-2bc2-42ad-b493-50a3dfb09987';
